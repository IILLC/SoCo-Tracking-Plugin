...
function add_scripts(){
	...
	wp_localize_script('soco_js', 'soco_donor_array', json_encode($donor_array)); //pass any php settings to javascript
...
//shortcodes - Code is in soco_expenditures
