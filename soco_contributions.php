		...
		$( "button[name=btn_change_contribution]" )
			...
			.click( function( event ) {
				...
				if ( action ){
					...
					.fail( function() {
						$( '#spn-buttons-' + contribution_id ).html( '<div class="alert alert-danger" role="alert"><strong>Oops!</strong> Something went wrong. Please reload the page and try again.</div>' );
					  });
